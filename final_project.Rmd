...
ggplot(data = region_suicide, mapping = aes(x = YEAR, y = RATE, group = STATE))+
  geom_line(aes(color = STATE)) +
  facet_wrap(~Region)

ggplot(data = region_suicide_top5_bottom5, mapping = aes(x = YEAR, y = RATE, group = STATE))+
  geom_line(aes(color = STATE))
